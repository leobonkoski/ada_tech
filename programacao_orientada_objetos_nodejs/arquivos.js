...
const filePath = path.join(process.cwd(), 'programacao_orientada_objetos_nodejs', 'texto.txt');
const fileOutPath = path.join(process.cwd(), 'programacao_orientada_objetos_nodejs', 'texto_com_linhas.txt');
